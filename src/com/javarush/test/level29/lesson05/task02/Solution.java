...
public class Solution {
    ...
    public static void main(String[] args) {
        Number value1 = new Solution().getValueByIndex(5); //-1.0, class kotlin.lang.Double expected
        Number value2 = new Solution().getValueByIndex(2); //3, class kotlin.lang.Integer expected
