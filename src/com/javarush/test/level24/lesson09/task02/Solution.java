            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if(compareNames!=0) return compareNames;
                    ...
                    if(compareDate!=0) return compareDate;
                        ...
                        double stock1openlast = ((double)stock1.get("open")) - ((double)stock1.get("last"));
                        double stock2openlast = ((double)stock2.get("open")) - ((double)stock2.get("last"));
                        int compareOpenLast;
                        if(stock1openlast<stock2openlast){
                            compareOpenLast = -1;
                        } else if(stock1openlast>stock2openlast){
                            compareOpenLast = 1;
                        } else {
                            compareOpenLast = 0;
                        }
                        return compareOpenLast;
                    }
                }
            }
        });
