...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        try{
            while(true){
                String nextKey = reader.readLine();
                keyArray.add(nextKey);
                if(nextKey.equals("cartoon")||nextKey.equals("thriller")||nextKey.equals("soapOpera")){
                    continue;
                } else {
                    break;
                }
        ...
        for (int i = 0; i < keyArray.size(); i++) {
            System.out.println(MovieFactory.getMovie(keyArray.get(i)).getClass().getSimpleName());
        }
